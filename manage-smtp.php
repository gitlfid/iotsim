...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_smtp'])) {
    ...
    if ($check->num_rows == 0) {
        $sql = "INSERT INTO smtp_settings (id, host, port, username, password, encryption, from_email, from_name) VALUES (1, ?, ?, ?, ?, ?, ?, ?)";
    } else {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['test_email'])) {
    ...
    $body = "<h1>It Works!</h1><p>This is a test email from your IoT Platform via PHPMailer.</p>";
